...
<template>
  <form>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-react" name="interest" type="checkbox" v-model="interest"/>
        <label for="interest-react">React.js</label>
      </div>
      <div>
        <input id="interest-vue" name="interest" type="checkbox" v-model="interest" />
        <label for="interest-vue">Vue.js</label>
      </div>
      <div>
        <input id="interest-angular" name="interest" type="checkbox" v-model="interest"/>
